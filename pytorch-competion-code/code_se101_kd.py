...
def train_model(model, criterion, criterion2,  optimizer, num_epochs=1):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch < 20 and epoch_loss <= least_loss_20:
            ...
            file.copy('senext101_20.pth', 's3://jian1299/' + 'se101_kd/' + 'senext101_20.pth')
            ...
            file.copy('senext101_40.pth', 's3://jian1299/' + 'se101_kd/' + 'senext101_40.pth')
            ...
            file.copy('senext101_80.pth', 's3://jian1299/' + 'se101_kd/' + 'senext101_80.pth')
            ...
            file.copy('senext101_120.pth', 's3://jian1299/' + 'se101_kd/' + 'senext101_120.pth')
