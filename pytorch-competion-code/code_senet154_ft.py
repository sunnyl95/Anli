...
src_model = os.path.join(src_folder, 'senet154-c7b49a05.pth')
dst_model = os.path.join(model_path, 'senet154-c7b49a05.pth')
...
def train_model(model, criterion, optimizer, num_epochs=1):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch >= 50 and epoch < 80 and epoch_loss <= least_loss_50:
            ...
            file.copy('./senet154_50.pth', 's3://' + OBS_Name + '/senet154_ft_newdata/senet154_50.pth')
            ...
            file.copy('./senet154_120.pth', 's3://' + OBS_Name + '/senet154_ft_newdata/senet154_120.pth')
            ...
            file.copy('./senet154_150.pth', 's3://' + OBS_Name + '/senet154_ft_newdata/senet154_150.pth')
            ...
            file.copy('./senet154_200.pth', 's3://' + OBS_Name + '/senet154_ft_newdata/senet154_200.pth')
