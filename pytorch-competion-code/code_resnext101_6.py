...
src_model = os.path.join(src_folder, 'resnext101_64x4d-e77a0586.pth')
dst_model = os.path.join(model_path, 'resnext101_64x4d-e77a0586.pth')
...
file.copy_parallel(os.path.join('s3://jian1299/garbage_data/Ftrain1'), file_folder_train)
file.copy_parallel(os.path.join('s3://jian1299/garbage_data/Ftest1'), file_folder_test)
...
save_file_name = 'rycy_6_a0_4'
# ###################################


# model = pretrainedmodels.resnext101_64x4d(pretrained='imagenet')
# model.last_linear = nn.Linear(2048, 40)


model = make_model('resnext101_64x4d', num_classes=40, pretrained=True)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'train' and epoch_loss <= train_loss:
                ...
                if muti_gpu:
                    torch.save(model.module.state_dict(), './' + save_file_name + '.pth')
