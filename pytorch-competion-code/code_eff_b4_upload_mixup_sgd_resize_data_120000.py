    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc >= best_acc and epoch_acc >= 0.905:
                best_acc = epoch_acc
                torch.save(model.module, './eff_b4_data_120000.pth')
                file.copy('./eff_b4_data_120000.pth', 's3://' + OBS_Name + '/eff_b4_data_120000/eff_b4_data_120000_acc.pth')

            if phase == 'val' and epoch_loss <= least_loss:
                least_loss = epoch_loss
                torch.save(model.module, './eff_b4_data_120000.pth')
                file.copy('./eff_b4_data_120000.pth', 's3://' + OBS_Name + '/eff_b4_data_120000/eff_b4_data_120000_loss.pth')
