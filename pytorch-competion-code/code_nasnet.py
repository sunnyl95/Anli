...
src_model = os.path.join(src_folder, 'pnasnet5large-bf079911.pth')
dst_model = os.path.join(model_path, 'pnasnet5large-bf079911.pth')
...
model.last_linear = nn.Linear(4320, 40)
